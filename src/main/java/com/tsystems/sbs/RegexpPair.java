...
/**
 * This class represents a Regexp/Replacement pair. It also compiles internally the regexp into a Pattern object 
 * to encourage that it is compiled only once to avoid performance issues.
 * @author ccapdevi
 *
 */
